...
if (!class_exists('MRKV_UA_SHIPPING_UKR_POSHTA'))
{
	/**
	 * Class for setup ukr poshta method
	 */
	class MRKV_UA_SHIPPING_UKR_POSHTA extends WC_Shipping_Method
	{
		public function __construct($instance_id = 0)
        {
            ...
            # Set main fields
            $this->id = 'mrkv_ua_shipping_ukr-poshta';
            $this->method_title = __( 'UkrPoshta Warehouse', 'mrkv-ua-shipping' );
        ...
        public function init_form_fields()
        {
            ...
            $this->instance_form_fields = array(
                ...
                'free_shipping_text' => array(
                    ...
                    'type' => 'text',
                    'placeholder' => __('FREE to UkrPoshta Warehouse', 'mrkv-ua-shipping'),
                    'description' => '',
                ),
            );
        }
