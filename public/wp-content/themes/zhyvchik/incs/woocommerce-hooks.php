...
// ФУНКЦІЯ ЩО ДОДАЄ ЗОБРАЖЕННЯ В КАТЕГОРІЮ ПРИ ВІДОБРАЖЕННІ В МЕНЮ "TOP"
...
function add_woo_category_image_to_menu( $title, $item, $args, $depth ) {
    ...
    // Перевіряємо, чи це саме те меню, яке нам потрібно (theme_location == 'top')
    ...
    // Повертаємо заголовок (змінений для 'top', або оригінальний для всіх інших меню)
    return $title;
}
