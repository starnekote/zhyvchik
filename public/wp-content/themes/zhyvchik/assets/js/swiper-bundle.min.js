...
const catalog = new Swiper('.catalog-categories-swiper', {
  slidesPerView: 3.5,
  spaceBetween: '1.8%',
  navigation: {
    enabled: false
...
// 👇 важливо! викликаємо init вручну, якщо Swiper ініціалізується після підключення
catalog.init();

new Swiper('.product-gallery-main-swiper', {
  slidesPerView: 1,
  thumbs: {
    swiper: {
      el: '.product-gallery-thumb-swiper',
      slidesPerView: 5,
      spaceBetween: "2%"
    }
  },
